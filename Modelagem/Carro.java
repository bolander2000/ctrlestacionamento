...
public class Carro {
    ...
    public Carro(Modelo modelo, String placa, LocalDateTime entrada, float valor, String saidaFormatado, String entradaFormatado) {
        this.modelo = modelo;
        this.placa = placa;
        this.entrada = entrada;
        this.valor = valor;
    ...
    public Carro(Modelo modelo, String placa, float valor, String saidaFormatado, String entradaFormatado, LocalDate entradaData) {
        this.modelo = modelo;
        this.placa = placa;
        this.valor = valor;
        this.saidaFormatado = saidaFormatado;
    ...
    public String toString(){
        ...
        return "Modelo: " + modelo + " | Placa: " + placa +" | Entrada: " + entradaFormatado +" | Saida: "+saidaFormatado +" | Preco: "+valor;
